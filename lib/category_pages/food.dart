...
class _FoodSellersPageState extends State<FoodSellersPage> {
  ...
  Future<void> postMessage() async {
    if (textController.text.isNotEmpty) {
      await FirebaseFirestore.instance.collection("food_posts").doc(textController.text).set({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromRGBO(215, 57, 239, 1),
      ),
      body: Center(
        child: Column(
          children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                        hintText: "What food services do you need?",
...
// SellerCard widget remains the same but updated for food context
